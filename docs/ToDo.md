...
1. Did you forget to add tasks in activity? I noticed you said there was no "updated_at" in tasks, maybe you could register when the task status is update to completed?
2. You also might have forgot to answer question 6 from my first prompt.
3. Im debating adding Hours logged and At-risk projects along with the KPI cards in maanger dashboard, thoughts?
